...
1.  **Fork 原始仓库**：将上游仓库 Fork 到您自己的 GitHub 账户下。
2.  **克隆到本地**：将您 Fork 后的仓库克隆到您的本地计算机。
3.  **下载更新工具**：获取用于同步上游更新的脚本或工具。
4.  **配置 Fork URL**：在本地仓库中添加指向上游仓库的远程 URL。
5.  **运行自动更新**：执行更新工具，将上游仓库的最新更改同步到您的 Fork 仓库。
